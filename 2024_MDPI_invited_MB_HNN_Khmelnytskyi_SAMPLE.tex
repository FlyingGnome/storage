...
\caption{
    The classic convolutional neural network (CNN)  (based on LCNet architecture) with the single input channel of the original images (a) and the hybrid neural network with 4 quanvolutional input channels (HNN-5QC).} \label{fig:models}
\end{figure}
...
\textcolor{red}{
\begin{table}[H] 
\caption{Comparison of AUC metrics with CIFAR-10 dataset.\label{tab_cifar_auc}}
\begin{tabularx}{\textwidth}{CCCCCCCC}
\toprule
...
\textcolor{red}{
\begin{table}[H] 
\caption{Comparison of accuracy with DermaMNIST dataset.\label{tab_derma_acc}}
...
\textcolor{red}{
\begin{table}[H] 
\caption{Comparison of AUC metrics with DermaMNIST dataset.\label{tab_derma_auc_split}}
\begin{tabularx}{\textwidth}{CCCCCCCC}
\toprule
\textbf{Backbone} & \textbf{Variant} & \textbf{AUC macro mean} & \textbf{AUC macro std} & \textbf{AUC micro mean} & \textbf{AUC micro std} & \textbf{$\Delta$AUC macro} & \textbf{$\Delta$AUC micro} \\
\midrule
